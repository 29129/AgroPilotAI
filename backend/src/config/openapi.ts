export const openApiDocument = {
  ...
  paths: {
    ...
    '/crops/{cropId}/analysis': { post: { summary: 'Ejecuta análisis multiagente', security: [{ bearerAuth: [] }], responses: { '201': { description: 'Análisis, evidencia y recomendaciones' } } } },
    '/crops/{cropId}/recommendations': { get: { summary: 'Lista recomendaciones explicables', security: [{ bearerAuth: [] }], responses: { '200': { description: 'Recomendaciones' } } } },
    '/recommendations/{recommendationId}/approve': { post: { summary: 'Aprueba una recomendación', security: [{ bearerAuth: [] }], responses: { '200': { description: 'Recomendación aprobada' } } } },
    '/recommendations/{recommendationId}/reject': { post: { summary: 'Rechaza una recomendación', security: [{ bearerAuth: [] }], responses: { '200': { description: 'Recomendación rechazada' } } } },
    '/recommendations/{recommendationId}/complete': { post: { summary: 'Completa una recomendación aprobada', security: [{ bearerAuth: [] }], responses: { '200': { description: 'Recomendación completada' } } } },
    '/crops/{cropId}/weekly-plans/generate': { post: { summary: 'Genera un plan semanal', security: [{ bearerAuth: [] }], responses: { '201': { description: 'Plan semanal' } } } },
    '/crops/{cropId}/weekly-plans/current': { get: { summary: 'Obtiene el plan semanal actual', security: [{ bearerAuth: [] }], responses: { '200': { description: 'Plan semanal' } } } },
    '/weekly-plans/{planId}': { get: { summary: 'Obtiene un plan semanal', security: [{ bearerAuth: [] }], responses: { '200': { description: 'Plan semanal' } } } },
    '/crops/{cropId}/weather': { get: { summary: 'Consulta el pronóstico del cultivo', security: [{ bearerAuth: [] }], responses: { '200': { description: 'Pronóstico' } } } },
    '/market/prices': { get: { summary: 'Consulta precio de mercado', security: [{ bearerAuth: [] }], responses: { '200': { description: 'Precio de referencia' } } } },
    '/conversations': { get: { summary: 'Lista conversaciones', security: [{ bearerAuth: [] }], responses: { '200': { description: 'Conversaciones' } } }, post: { summary: 'Crea una conversación', security: [{ bearerAuth: [] }], responses: { '201': { description: 'Conversación creada' } } } },
    '/conversations/{conversationId}': { get: { summary: 'Obtiene una conversación', security: [{ bearerAuth: [] }], responses: { '200': { description: 'Conversación' } } } },
    '/conversations/{conversationId}/messages': { post: { summary: 'Envía un mensaje al asistente', security: [{ bearerAuth: [] }], responses: { '201': { description: 'Respuesta estructurada' } } } },
  },
};
